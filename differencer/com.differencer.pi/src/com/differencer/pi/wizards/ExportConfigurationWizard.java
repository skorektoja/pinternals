...
public class ExportConfigurationWizard extends Wizard implements IExportWizard {
	...
	public ExportConfigurationWizard() {
		...
		IDialogSettings section = workbenchSettings.getSection("piConfigurationExportWizard");//$NON-NLS-1$
		if (section == null) {
			section = workbenchSettings.addNewSection("piConfigurationExportWizard");//$NON-NLS-1$
		}
	...
	public void init(IWorkbench workbench, IStructuredSelection currentSelection) {
		...
		setWindowTitle("Export PI Configuration");
